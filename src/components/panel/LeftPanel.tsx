        ...
        <>
          ...
          <div className="flex border-b border-gray-700" role="tablist" aria-label="Vista waypoint">
            <button
              ...
              className={`flex-1 py-2 text-xs text-center transition-colors max-lg:min-h-[44px] ${view === 'edit' ? 'text-green-400 border-b-2 border-green-400' : 'text-gray-400 hover:text-gray-300'}`}
            >
              Modifica
            </button>
            <button
              ...
              className={`flex-1 py-2 text-xs text-center transition-colors max-lg:min-h-[44px] ${view === 'table' ? 'text-green-400 border-b-2 border-green-400' : 'text-gray-400 hover:text-gray-300'}`}
            >
              Tabella
            </button>
          </div>
